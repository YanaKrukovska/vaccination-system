...
class VaccinationServiceTest {
    ...
    void addVaccinationDoctorIsNull() {
        ...
        assertEquals("Vaccination date can't be null", result.getErrors().get(1));
        assertEquals("Vaccine type can't be null", result.getErrors().get(2));
    ...
    void addVaccinationDateIsNull() {
        ...
        assertEquals("Vaccine type can't be null", result.getErrors().get(1));
        verify(repository, never()).save(any());
    }
